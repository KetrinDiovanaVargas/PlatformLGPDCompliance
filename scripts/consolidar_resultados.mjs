...
/**
 * Script de consolidação: Agrupa logs e gera relatório de métricas
 * 
 * Calcula: taxa de acerto, falsos positivos/negativos, pontuação média.
 * Agrupa resultados por persona e nível de risco.
 * Salva consolidado em logs/consolidado_YYYY-MM-DD.json
 * 
 * Uso: node scripts/consolidar_resultados.mjs
 */
...
/**
 * Executa consolidação de todos os logs.
 */
function consolidarResultados() {
  ...
  if (logFiles.length === 0) {
    console.log('  Nenhum log encontrado em logs/')
    return
  }
